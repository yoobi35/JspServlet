...
@MultipartConfig(
    location = "D:/storage", // ---- 업로드 파일을 저정할 디렉터리 경로
...
public class UploadFile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  String filename = System.currentTimeMillis()+ "_" + part.getSubmittedFileName(); // 타임스탬프 + 밑줄 + 첨부파일이름
	  part.write(filename);
	  ...
	  for (File file : files) {
	    String storedFilename = file.getName(); // 타임스탬프 + 밑줄 + 첨부파일이름
